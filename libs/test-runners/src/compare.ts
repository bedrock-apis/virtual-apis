...
export async function runAndCompare(bdsDocsResults: TestReport.Run, Environment: TestEnvironment, runner?: ThreadRunner) {
   const result = await TestSuite.r(Environment, runner);
