...
export const BiomeSearchOptions = CONTEXT.registerType(
  "BiomeSearchOptions",
  new Types.InterfaceBindType("BiomeSearchOptions", null).addProperty("boundingSize"),
);
export const BlockCustomComponent = CONTEXT.registerType(
  "BlockCustomComponent",
  new Types.InterfaceBindType("BlockCustomComponent", null)
...
export const BlockEventOptions = CONTEXT.registerType(
  "BlockEventOptions",
  new Types.InterfaceBindType("BlockEventOptions", null).addProperty("blockTypes").addProperty("permutations"),
);
export const BlockFillOptions = CONTEXT.registerType(
  "BlockFillOptions",
  new Types.InterfaceBindType("BlockFillOptions", null)
    .addProperty("blockFilter")
    .addProperty("ignoreChunkBoundErrors"),
);
export const BlockFilter = CONTEXT.registerType(
  "BlockFilter",
  new Types.InterfaceBindType("BlockFilter", null)
...
export const BlockHitInformation = CONTEXT.registerType(
  "BlockHitInformation",
  new Types.InterfaceBindType("BlockHitInformation", null)
    .addProperty("block")
    .addProperty("face")
    .addProperty("faceLocation"),
);
export const BlockRaycastHit = CONTEXT.registerType(
  "BlockRaycastHit",
  new Types.InterfaceBindType("BlockRaycastHit", null)
    .addProperty("block")
    .addProperty("face")
    .addProperty("faceLocation"),
);
export const BlockRaycastOptions = CONTEXT.registerType(
  "BlockRaycastOptions",
  new Types.InterfaceBindType("BlockRaycastOptions", BlockFilter)
    .addProperty("includeLiquidBlocks")
    .addProperty("includePassableBlocks")
    .addProperty("maxDistance"),
);
export const BoundingBox = CONTEXT.registerType(
  "BoundingBox",
  new Types.InterfaceBindType("BoundingBox", null).addProperty("max").addProperty("min"),
);
export const CameraDefaultOptions = CONTEXT.registerType(
  "CameraDefaultOptions",
  new Types.InterfaceBindType("CameraDefaultOptions", null).addProperty("easeOptions"),
);
export const CameraEaseOptions = CONTEXT.registerType(
  "CameraEaseOptions",
  new Types.InterfaceBindType("CameraEaseOptions", null).addProperty("easeTime").addProperty("easeType"),
);
export const CameraFadeOptions = CONTEXT.registerType(
  "CameraFadeOptions",
  new Types.InterfaceBindType("CameraFadeOptions", null).addProperty("fadeColor").addProperty("fadeTime"),
);
export const CameraFadeTimeOptions = CONTEXT.registerType(
  "CameraFadeTimeOptions",
  new Types.InterfaceBindType("CameraFadeTimeOptions", null)
    .addProperty("fadeInTime")
    .addProperty("fadeOutTime")
    .addProperty("holdTime"),
);
export const CameraFixedBoomOptions = CONTEXT.registerType(
  "CameraFixedBoomOptions",
  new Types.InterfaceBindType("CameraFixedBoomOptions", null).addProperty("viewOffset"),
);
export const CameraSetFacingOptions = CONTEXT.registerType(
  "CameraSetFacingOptions",
  new Types.InterfaceBindType("CameraSetFacingOptions", null)
    .addProperty("easeOptions")
    .addProperty("facingEntity")
    .addProperty("location"),
);
export const CameraSetLocationOptions = CONTEXT.registerType(
  "CameraSetLocationOptions",
  new Types.InterfaceBindType("CameraSetLocationOptions", null).addProperty("easeOptions").addProperty("location"),
);
export const CameraSetPosOptions = CONTEXT.registerType(
  "CameraSetPosOptions",
  new Types.InterfaceBindType("CameraSetPosOptions", null)
    .addProperty("easeOptions")
    .addProperty("facingLocation")
    .addProperty("location"),
);
export const CameraSetRotOptions = CONTEXT.registerType(
  "CameraSetRotOptions",
  new Types.InterfaceBindType("CameraSetRotOptions", null)
    .addProperty("easeOptions")
    .addProperty("location")
    .addProperty("rotation"),
);
export const CompoundBlockVolumeItem = CONTEXT.registerType(
  "CompoundBlockVolumeItem",
  new Types.InterfaceBindType("CompoundBlockVolumeItem", null)
    .addProperty("action")
    .addProperty("locationRelativity")
    .addProperty("volume"),
);
export const DefinitionModifier = CONTEXT.registerType(
  "DefinitionModifier",
  new Types.InterfaceBindType("DefinitionModifier", null)
    .addProperty("addedComponentGroups")
    .addProperty("removedComponentGroups")
    .addProperty("triggers"),
);
export const DimensionLocation = CONTEXT.registerType(
  "DimensionLocation",
  new Types.InterfaceBindType("DimensionLocation", null)
    .addProperty("dimension")
    .addProperty("x")
    .addProperty("y")
    .addProperty("z"),
);
export const Enchantment = CONTEXT.registerType(
  "Enchantment",
  new Types.InterfaceBindType("Enchantment", null).addProperty("level").addProperty("type"),
);
export const EntityApplyDamageByProjectileOptions = CONTEXT.registerType(
  "EntityApplyDamageByProjectileOptions",
  new Types.InterfaceBindType("EntityApplyDamageByProjectileOptions", null)
    .addProperty("damagingEntity")
    .addProperty("damagingProjectile"),
);
export const EntityApplyDamageOptions = CONTEXT.registerType(
  "EntityApplyDamageOptions",
  new Types.InterfaceBindType("EntityApplyDamageOptions", null).addProperty("cause").addProperty("damagingEntity"),
);
export const EntityDamageSource = CONTEXT.registerType(
  "EntityDamageSource",
  new Types.InterfaceBindType("EntityDamageSource", null)
    .addProperty("cause")
    .addProperty("damagingEntity")
    .addProperty("damagingProjectile"),
);
export const EntityDataDrivenTriggerEventOptions = CONTEXT.registerType(
  "EntityDataDrivenTriggerEventOptions",
  new Types.InterfaceBindType("EntityDataDrivenTriggerEventOptions", null)
    .addProperty("entities")
    .addProperty("entityTypes")
    .addProperty("eventTypes"),
);
export const EntityEffectOptions = CONTEXT.registerType(
  "EntityEffectOptions",
  new Types.InterfaceBindType("EntityEffectOptions", null).addProperty("amplifier").addProperty("showParticles"),
);
export const EntityEventOptions = CONTEXT.registerType(
  "EntityEventOptions",
  new Types.InterfaceBindType("EntityEventOptions", null).addProperty("entities").addProperty("entityTypes"),
);
export const EntityFilter = CONTEXT.registerType(
  "EntityFilter",
  new Types.InterfaceBindType("EntityFilter", null)
...
export const EntityHitInformation = CONTEXT.registerType(
  "EntityHitInformation",
  new Types.InterfaceBindType("EntityHitInformation", null).addProperty("entity"),
);
export const EntityQueryOptions = CONTEXT.registerType(
  "EntityQueryOptions",
  new Types.InterfaceBindType("EntityQueryOptions", EntityFilter)
    .addProperty("closest")
...
export const EntityQueryPropertyOptions = CONTEXT.registerType(
  "EntityQueryPropertyOptions",
  new Types.InterfaceBindType("EntityQueryPropertyOptions", null)
    .addProperty("exclude")
    .addProperty("propertyId")
    .addProperty("value"),
);
export const EntityQueryScoreOptions = CONTEXT.registerType(
  "EntityQueryScoreOptions",
  new Types.InterfaceBindType("EntityQueryScoreOptions", null)
    .addProperty("exclude")
    .addProperty("maxScore")
    .addProperty("minScore")
    .addProperty("objective"),
);
export const EntityRaycastHit = CONTEXT.registerType(
  "EntityRaycastHit",
  new Types.InterfaceBindType("EntityRaycastHit", null).addProperty("distance").addProperty("entity"),
);
export const EntityRaycastOptions = CONTEXT.registerType(
  "EntityRaycastOptions",
  new Types.InterfaceBindType("EntityRaycastOptions", EntityFilter)
    .addProperty("ignoreBlockCollision")
    .addProperty("includeLiquidBlocks")
    .addProperty("includePassableBlocks")
    .addProperty("maxDistance"),
);
export const EqualsComparison = CONTEXT.registerType(
  "EqualsComparison",
  new Types.InterfaceBindType("EqualsComparison", null).addProperty("equals"),
);
export const ExplosionOptions = CONTEXT.registerType(
  "ExplosionOptions",
  new Types.InterfaceBindType("ExplosionOptions", null)
    .addProperty("allowUnderwater")
    .addProperty("breaksBlocks")
    .addProperty("causesFire")
    .addProperty("source"),
);
export const GreaterThanComparison = CONTEXT.registerType(
  "GreaterThanComparison",
  new Types.InterfaceBindType("GreaterThanComparison", null).addProperty("greaterThan"),
);
export const GreaterThanOrEqualsComparison = CONTEXT.registerType(
  "GreaterThanOrEqualsComparison",
  new Types.InterfaceBindType("GreaterThanOrEqualsComparison", null).addProperty("greaterThanOrEquals"),
);
export const InputEventOptions = CONTEXT.registerType(
  "InputEventOptions",
  new Types.InterfaceBindType("InputEventOptions", null).addProperty("buttons").addProperty("state"),
);
export const ItemCustomComponent = CONTEXT.registerType(
  "ItemCustomComponent",
  new Types.InterfaceBindType("ItemCustomComponent", null)
...
export const JigsawPlaceOptions = CONTEXT.registerType(
  "JigsawPlaceOptions",
  new Types.InterfaceBindType("JigsawPlaceOptions", null).addProperty("keepJigsaws"),
);
export const JigsawStructurePlaceOptions = CONTEXT.registerType(
  "JigsawStructurePlaceOptions",
  new Types.InterfaceBindType("JigsawStructurePlaceOptions", null)
    .addProperty("ignoreStartHeight")
    .addProperty("keepJigsaws"),
);
export const LessThanComparison = CONTEXT.registerType(
  "LessThanComparison",
  new Types.InterfaceBindType("LessThanComparison", null).addProperty("lessThan"),
);
export const LessThanOrEqualsComparison = CONTEXT.registerType(
  "LessThanOrEqualsComparison",
  new Types.InterfaceBindType("LessThanOrEqualsComparison", null).addProperty("lessThanOrEquals"),
);
export const MusicOptions = CONTEXT.registerType(
  "MusicOptions",
  new Types.InterfaceBindType("MusicOptions", null).addProperty("fade").addProperty("loop").addProperty("volume"),
);
export const NotEqualsComparison = CONTEXT.registerType(
  "NotEqualsComparison",
  new Types.InterfaceBindType("NotEqualsComparison", null).addProperty("notEquals"),
);
export const PlayAnimationOptions = CONTEXT.registerType(
  "PlayAnimationOptions",
  new Types.InterfaceBindType("PlayAnimationOptions", null)
...
export const PlayerSoundOptions = CONTEXT.registerType(
  "PlayerSoundOptions",
  new Types.InterfaceBindType("PlayerSoundOptions", null)
    .addProperty("location")
    .addProperty("pitch")
    .addProperty("volume"),
);
export const PotionOptions = CONTEXT.registerType(
  "PotionOptions",
  new Types.InterfaceBindType("PotionOptions", null)
    .addProperty("effect")
    .addProperty("liquid")
    .addProperty("modifier"),
);
export const ProjectileShootOptions = CONTEXT.registerType(
  "ProjectileShootOptions",
  new Types.InterfaceBindType("ProjectileShootOptions", null).addProperty("uncertainty"),
);
export const RangeComparison = CONTEXT.registerType(
  "RangeComparison",
  new Types.InterfaceBindType("RangeComparison", null).addProperty("lowerBound").addProperty("upperBound"),
);
export const RawMessage = CONTEXT.registerType(
  "RawMessage",
  new Types.InterfaceBindType("RawMessage", null)
    .addProperty("rawtext")
    .addProperty("score")
    .addProperty("text")
...
export const RawMessageScore = CONTEXT.registerType(
  "RawMessageScore",
  new Types.InterfaceBindType("RawMessageScore", null).addProperty("name").addProperty("objective"),
);
export const RawText = CONTEXT.registerType(
  "RawText",
  new Types.InterfaceBindType("RawText", null).addProperty("rawtext"),
);
export const RGB = CONTEXT.registerType(
  "RGB",
  new Types.InterfaceBindType("RGB", null).addProperty("blue").addProperty("green").addProperty("red"),
);
export const RGBA = CONTEXT.registerType("RGBA", new Types.InterfaceBindType("RGBA", RGB).addProperty("alpha"));
export const ScoreboardObjectiveDisplayOptions = CONTEXT.registerType(
  "ScoreboardObjectiveDisplayOptions",
  new Types.InterfaceBindType("ScoreboardObjectiveDisplayOptions", null)
    .addProperty("objective")
    .addProperty("sortOrder"),
);
export const ScriptEventMessageFilterOptions = CONTEXT.registerType(
  "ScriptEventMessageFilterOptions",
  new Types.InterfaceBindType("ScriptEventMessageFilterOptions", null).addProperty("namespaces"),
);
export const SpawnEntityOptions = CONTEXT.registerType(
  "SpawnEntityOptions",
  new Types.InterfaceBindType("SpawnEntityOptions", null)
    .addProperty("initialPersistence")
    .addProperty("initialRotation"),
);
export const StructureCreateOptions = CONTEXT.registerType(
  "StructureCreateOptions",
  new Types.InterfaceBindType("StructureCreateOptions", null)
    .addProperty("includeBlocks")
    .addProperty("includeEntities")
    .addProperty("saveMode"),
);
export const StructurePlaceOptions = CONTEXT.registerType(
  "StructurePlaceOptions",
  new Types.InterfaceBindType("StructurePlaceOptions", null)
...
export const TeleportOptions = CONTEXT.registerType(
  "TeleportOptions",
  new Types.InterfaceBindType("TeleportOptions", null)
...
export const TitleDisplayOptions = CONTEXT.registerType(
  "TitleDisplayOptions",
  new Types.InterfaceBindType("TitleDisplayOptions", null)
    .addProperty("fadeInDuration")
    .addProperty("fadeOutDuration")
    .addProperty("stayDuration")
    .addProperty("subtitle"),
);
export const Vector2 = CONTEXT.registerType(
  "Vector2",
  new Types.InterfaceBindType("Vector2", null).addProperty("x").addProperty("y"),
);
export const Vector3 = CONTEXT.registerType(
  "Vector3",
  new Types.InterfaceBindType("Vector3", null).addProperty("x").addProperty("y").addProperty("z"),
);
export const VectorXZ = CONTEXT.registerType(
  "VectorXZ",
  new Types.InterfaceBindType("VectorXZ", null).addProperty("x").addProperty("z"),
);
export const WorldSoundOptions = CONTEXT.registerType(
  "WorldSoundOptions",
  new Types.InterfaceBindType("WorldSoundOptions", null).addProperty("pitch").addProperty("volume"),
);
...
export const BlockFluidContainerComponent = CONTEXT.createClassDefinition(
  ...
  .addMethod("getFluidType", Types.ParamsDefinition.From(CONTEXT, []))
  .addMethod(
    "setFluidType",
    Types.ParamsDefinition.From(CONTEXT, [
      {
...
export const ButtonPushAfterEventSignal = CONTEXT.createClassDefinition("ButtonPushAfterEventSignal", null, null, true)
  .addMethod(
    "subscribe",
    Types.ParamsDefinition.From(CONTEXT, [
      {
...
export const SystemInfo = CONTEXT.createClassDefinition("SystemInfo", null, null, true);
export const ClientSystemInfo = CONTEXT.createClassDefinition("ClientSystemInfo", SystemInfo, null, true);
...
export const InputInfo = CONTEXT.createClassDefinition("InputInfo", null, null, true)
  .addMethod(
    "getButtonState",
    Types.ParamsDefinition.From(CONTEXT, [
      {
  ...
  .addMethod("getMovementVector", Types.ParamsDefinition.From(CONTEXT, []));
...
export const ItemCompostableComponent = CONTEXT.createClassDefinition(
...
export const ItemDyeableComponent = CONTEXT.createClassDefinition("ItemDyeableComponent", ItemComponent, null, true);
...
export const PlayerButtonInputAfterEvent = CONTEXT.createClassDefinition(
  "PlayerButtonInputAfterEvent",
  null,
  null,
  true,
);
export const PlayerButtonInputAfterEventSignal = CONTEXT.createClassDefinition(
...
export const PlayerInputModeChangeAfterEvent = CONTEXT.createClassDefinition(
  "PlayerInputModeChangeAfterEvent",
  null,
  null,
  true,
);
export const PlayerInputModeChangeAfterEventSignal = CONTEXT.createClassDefinition(
...
export const PlayerJoinAfterEventSignal = CONTEXT.createClassDefinition("PlayerJoinAfterEventSignal", null, null, true)
  .addMethod(
    "subscribe",
    Types.ParamsDefinition.From(CONTEXT, [
      {
...
export const ShutdownBeforeEventSignal = CONTEXT.createClassDefinition("ShutdownBeforeEventSignal", null, null, true)
  .addMethod(
    "subscribe",
    Types.ParamsDefinition.From(CONTEXT, [
      {
...
export const ShutdownEvent = CONTEXT.createClassDefinition("ShutdownEvent", null, null, true);
export const StartupBeforeEventSignal = CONTEXT.createClassDefinition("StartupBeforeEventSignal", null, null, true)
  .addMethod(
    "subscribe",
    Types.ParamsDefinition.From(CONTEXT, [
      {
...
export const StartupEvent = CONTEXT.createClassDefinition("StartupEvent", null, null, true);
...
export const WorldLoadAfterEvent = CONTEXT.createClassDefinition("WorldLoadAfterEvent", null, null, true);
export const WorldLoadAfterEventSignal = CONTEXT.createClassDefinition("WorldLoadAfterEventSignal", null, null, true)
  .addMethod(
    "subscribe",
    Types.ParamsDefinition.From(CONTEXT, [
      {
