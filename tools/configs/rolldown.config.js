...
var rolldown_config_default = [
	new ExportOption("./tools/configs/rolldown.config.ts", "./tools/configs/rolldown.config.js"),
	new ExportOption("./tools/linter/config.ts", "./eslint.config.js"),
	new ExportOption("./tools/build/index.ts", "./dist/build/index.js")
];
