export class Kernel {
  static __call = Function.prototype.call // Type to Type call method
  ...
  static Construct(name, useNew = true, ...args) {
    if (useNew)
      return Kernel.__setPrototypeOf(
        new Kernel[name + '::constructor'](...args),
        Kernel[name + '::prototype'],
      )
    else
      return Kernel.__setPrototypeOf(
        Kernel[name + '::constructor'](...args),
        Kernel[name + '::prototype'],
      )
  }
...
for (const constructor of classes) {
  ...
  Kernel[constructor.name + '::prototype'] = Object.defineProperties(
    {},
    Object.getOwnPropertyDescriptors(constructor.prototype),
  )
  Kernel[constructor.name + '::static'] = Object.defineProperties(
    {},
...
$native_functions.add(
  (Function.prototype.toString = function () {
    ...
    const string = Kernel.As(
      Kernel.call(Kernel['Function::prototype'].toString, this),
      'String',
    )
    return string + ''
  }),
