export class Kernel {
  ...
  static Construct(name, useNew = true, ...args) {
    if (useNew)
      return Kernel.__setPrototypeOf(new Kernel[name + '::constructor'](...args), Kernel[name + '::prototype']);
...
$native_functions.add(
  (Function.prototype.toString = function () {
    ...
    const string = Kernel.As(Kernel.call(Kernel['Function::prototype'].toString, this), 'String');
    return string + '';
  }),
);
