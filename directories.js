...
const sourceCode = fs
   .readFileSync(import.meta.filename, 'utf-8')
   .replace(/^\/\/ CODE BELOW IS AUTOGENERATED[^]+/m, '// CODE BELOW IS AUTOGENERATED');
...
export async function objectFromDir(dir, onlyFiles = false) {
   ...
   for (const entry of await fs.promises.readdir(dir, { withFileTypes: true })) {
      ...
      if (entry.isFile() && ['.js', '.ts', '.json'].includes(ext)) {
...
export const DIST = {
   "all_js": "./dist/all.js",
   "api_builder_BeTfGMZ0_js": "./dist/api-builder-BeTfGMZ0.js",
   "core_pKIQrm9n_js": "./dist/core-pKIQrm9n.js",
   "core_js": "./dist/core.js",
   "get_module_versions_4uYrXW_e_js": "./dist/get-module-versions-4uYrXW-e.js",
   "hooks_js": "./dist/hooks.js",
   "index_js": "./dist/index.js",
   "inventory_js": "./dist/inventory.js",
   "kernel_C5_z_tZG_js": "./dist/kernel-C5_z-tZG.js",
   "loader_js": "./dist/loader.js",
   "modules_Jk0cwsFZ_js": "./dist/modules-Jk0cwsFZ.js",
   "modules_js": "./dist/modules.js",
   "package_builder_js": "./dist/package-builder.js",
   "plugin_CD4qUlT2_js": "./dist/plugin-CD4qUlT2.js",
   "plugins": {
...
export const SRC = {
   "api_builder": {
      ...
      "kernel_test_ts": "./src/api-builder/kernel.test.ts",
      "kernel_ts": "./src/api-builder/kernel.ts",
      "plugin": {
         "api_ts": "./src/api-builder/plugin/api.ts",
         "get_module_versions_ts": "./src/api-builder/plugin/get-module-versions.ts",
         "index_ts": "./src/api-builder/plugin/index.ts"
      },
      "type_validators": {
   ...
   "package_builder": {
      ...
      "console_formatting_ts": "./src/package-builder/console-formatting.ts",
